...
namespace CCat {
    // TODO add Methode "addAction(std::function)" (adds function thats activated when the button is pressed)
    // TODO set Position of the text to the center of the Button
    export class Button {
    public:
